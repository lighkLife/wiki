...
- Channels 非阻塞读写的通道，实际上是文件、socket 连接（文件描述符）
...
以下使用 [Doug Lea](https://www.cs.oswego.edu/~dl/) 老爷子的 Scalable IO in Java [1^] 演讲搞中的例子，来使用 JAVA NIO 实现一个简单的 NIO Socket Server。
